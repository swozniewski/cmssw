...
patTaus = cms.EDProducer("PATTauProducer",
    ...
    tauIDSources = cms.PSet(
        ...
        againstElectronVLooseMVA6 = tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff99"),
        againstElectronLooseMVA6 = tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff96"),
        againstElectronMediumMVA6 = tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff91"),
        againstElectronTightMVA6 = tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff85"),
        againstElectronVTightMVA6 = tauIDMVAinputs("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff79"),
    ),
