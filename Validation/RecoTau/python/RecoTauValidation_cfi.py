...
proc.RunHPSValidation.discriminators = cms.VPSet(
   ...
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseChargedIsolation"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseChargedIsolation"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightChargedIsolation"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightCombinedIsolationDBSumPtCorr3Hits"),plotStep = cms.bool(True),selectionCut = cms.double(0.5),container = cms.string("")),
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseMuonRejection3"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightMuonRejection3"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLoosePileupWeightedIsolation3Hits"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumPileupWeightedIsolation3Hits"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   #cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightPileupWeightedIsolation3Hits"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VLooseElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPeff98")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6LooseElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPeff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6MediumElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPeff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6TightElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPeff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VTightElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPeff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBoldDMwLT", "_WPEff40")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBnewDMwLT", "_WPEff40")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1PWoldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWoldDMwLT", "_WPEff40")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1PWnewDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWnewDMwLT", "_WPEff40")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightCombinedIsolationDBSumPtCorr3HitsdR03"),plotStep = cms.bool(False),selectionCut = cms.double(0.5),container = cms.string("")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1DBdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1DBdR03oldDMwLT", "_WPEff40")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVLooseIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff90")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByLooseIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff80")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMediumIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff70")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByTightIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff60")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVTightIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff50")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByVVTightIsolationMVArun2v1PWdR03oldDMwLT"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByIsolationMVArun2v1PWdR03oldDMwLT", "_WPEff40"))
)
