...
proc.RunHPSValidation.discriminators = cms.VPSet(
   ...
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VLooseElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff99")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6LooseElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff96")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6MediumElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff91")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6TightElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff85")),
   cms.PSet( discriminator = cms.string("hpsPFTauDiscriminationByMVA6VTightElectronRejection"),plotStep = cms.bool(False),**extractWP("hpsPFTauDiscriminationByMVA6ElectronRejection", "_WPEff79")),
